...
function GitHubStarButton() {
  ...
  return (
    <a
      ...
      className="group relative inline-flex items-center justify-center rounded-md text-sm font-medium transition-transform duration-200 hover:scale-105 active:scale-95 animate-rainbow cursor-pointer border-0 h-10 px-4 py-2"
      style={{
        background:
    ...
    >
      <span
        className="absolute bottom-[-20%] left-1/2 z-0 h-[20%] w-[60%] -translate-x-1/2 animate-rainbow"
        style={{
          background:
      ...
      <div className="flex items-center relative z-10">
        ...
        <span className="ml-1 text-white text-sm p-1">Star on GitHub</span>
      </div>
      <div className="ml-2 flex items-center gap-1 text-sm relative z-10">
        <svg
